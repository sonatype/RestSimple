...
public final class ServiceDefinitionProxy implements Opcodes {
    ...
    private static ServiceDefinitionClient generate(SimpleAsyncHttpClient sahc, ServiceDefinition serviceDefinition) {
        ...
        cw.visit(V1_6, ACC_PUBLIC + ACC_SUPER, "org/sonatype/restsimple/client/model/ServiceDefinitionClientImpl", null, "org/sonatype/restsimple/client/ServiceDefinitionClient", null);
        ...
        }
        {
            ...
            mv.visitMethodInsn(INVOKESPECIAL, "org/sonatype/restsimple/client/ServiceDefinitionClient", "<init>", "()V");
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 1);
            mv.visitFieldInsn(PUTFIELD, "org/sonatype/restsimple/client/model/ServiceDefinitionClientImpl", "sahc", "Lcom/ning/http/client/SimpleAsyncHttpClient;");
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 2);
            mv.visitFieldInsn(PUTFIELD, "org/sonatype/restsimple/client/model/ServiceDefinitionClientImpl", "remoteServerUri", "Ljava/lang/String;");
            mv.visitInsn(RETURN);
            mv.visitMaxs(2, 3);
            mv.visitEnd();
        }
            ...
            if (serviceHandler.getHttpMethod().name().equalsIgnoreCase("get")) {
                {
                    ...
                    mv.visitVarInsn(ALOAD, 0);
                    mv.visitLdcInsn(serviceHandler.path());
                    mv.visitVarInsn(ALOAD, 2);
                    ...
                    mv.visitLabel(l0);
                    mv.visitVarInsn(ALOAD, 0);
                    mv.visitFieldInsn(GETFIELD, "org/sonatype/restsimple/client/model/ServiceDefinitionClientImpl", "sahc", "Lcom/ning/http/client/SimpleAsyncHttpClient;");
                    ...
                    mv.visitVarInsn(ALOAD, 0);
                    mv.visitFieldInsn(GETFIELD, "org/sonatype/restsimple/client/model/ServiceDefinitionClientImpl", "remoteServerUri", "Ljava/lang/String;");
                    ...
                    mv.visitLabel(l2);
                    mv.visitFrame(Opcodes.F_FULL, 4, new Object[]{"org/sonatype/restsimple/client/model/ServiceDefinitionClientImpl", "[Ljava/lang/String;", "java/util/List", "java/lang/String"}, 1, new Object[]{"java/lang/Throwable"});
            ...
            if (serviceHandler.getHttpMethod().name().equalsIgnoreCase("post")) {
                {
                    ...
                    mv.visitInsn(ARETURN);
                    mv.visitLabel(l2);
                    mv.visitFrame(Opcodes.F_FULL, 6, new Object[]{"org/sonatype/restsimple/client/model/ServiceDefinitionClientImpl", "java/util/Map", "[Ljava/lang/String;", "com/ning/http/client/FluentStringsMap", "java/util/List", "java/lang/String"}, 1, new Object[]{"java/lang/Throwable"});
