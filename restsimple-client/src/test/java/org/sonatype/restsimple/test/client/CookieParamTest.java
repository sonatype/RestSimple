...
public abstract class CookieParamTest extends BaseTest {
    ...
    public void testBasicGetGenerate() throws Throwable {
        ...
        assertEquals(petString, "Pet{name='pouetpouet--chatchien--$Version=1;a=b;$Domain=localhost;$Path=/'}");
    }
    ...
    public static interface ProxyClient {
        ...
        public Pet get(@CookieParam("foo") Cookie cookie, @PathParam("getPet") String path);
        ...
        @Produces(PetstoreAction.APPLICATION + "/" + PetstoreAction.JSON)
        @Consumes(PetstoreAction.APPLICATION + "/" + PetstoreAction.JSON)                        
        public Pet post(@PathParam("addPet") String myPet, @HeaderParam(PetstoreAction.PET_EXTRA_NAME) String petType, String body);
