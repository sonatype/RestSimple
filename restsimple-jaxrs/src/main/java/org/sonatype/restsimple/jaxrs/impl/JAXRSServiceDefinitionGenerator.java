...
public class JAXRSServiceDefinitionGenerator implements ServiceDefinitionGenerator, Opcodes {
    ...
    public void generate(ServiceDefinition serviceDefinition) {
        ...
        for (ServiceHandler serviceHandler : serviceDefinition.serviceHandlers()) {
            {
                ...
                if (serviceHandler.getHttpMethod().name().equalsIgnoreCase("get")) {
                    mv = cw.visitMethod(ACC_PUBLIC, methodName, "(Ljava/lang/String;Ljava/lang/String;)Lorg/sonatype/restsimple/api/ServiceHandlerMediaType;", null, null);
                    {
        ...
        }
        {
            ...
            Label l7 = new Label();
            mv.visitLabel(l7);
            mv.visitFrame(Opcodes.F_FULL, 13, new Object[]{className, "java/lang/String", "java/lang/String", "java/lang/String", "javax/ws/rs/core/MultivaluedMap", "org/sonatype/restsimple/api/ServiceHandler", "java/lang/String", "[Ljava/lang/Class;", "[Ljava/lang/Object;", Opcodes.TOP, Opcodes.INTEGER, "java/util/List", "java/util/Iterator"}, 0, new Object[]{});
            ...
            mv.visitLabel(l5);
            mv.visitFrame(Opcodes.F_FULL, 9, new Object[]{className, "java/lang/String", "java/lang/String", "java/lang/String", "javax/ws/rs/core/MultivaluedMap", "org/sonatype/restsimple/api/ServiceHandler", "java/lang/String", "[Ljava/lang/Class;", "[Ljava/lang/Object;"}, 0, new Object[]{});
            mv.visitVarInsn(ALOAD, 0);
