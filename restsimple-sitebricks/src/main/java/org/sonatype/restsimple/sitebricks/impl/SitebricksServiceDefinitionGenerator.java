...
public class SitebricksServiceDefinitionGenerator implements ServiceDefinitionGenerator, Opcodes {
    ...
    public void generate(final ServiceDefinition serviceDefinition) {
        ...
        {
            fv = cw.visitField(0, "serviceEntity", "Lorg/sonatype/restsimple/api/ServiceEntity;", null, null);
            {
...

        {
            ...
            mv.visitVarInsn(ALOAD, 4);
            mv.visitMethodInsn(INVOKEVIRTUAL, "org/sonatype/restsimple/api/ServiceHandler", "getHttpMethod", "()Lorg/sonatype/restsimple/api/ServiceDefinition$HttpMethod;");
            mv.visitMethodInsn(INVOKEVIRTUAL, "org/sonatype/restsimple/api/ServiceDefinition$HttpMethod", "name", "()Ljava/lang/String;");
            mv.visitVarInsn(ALOAD, 1);
            ...
            mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
            mv.visitVarInsn(ALOAD, 4);
            mv.visitMethodInsn(INVOKEVIRTUAL, "org/sonatype/restsimple/api/ServiceHandler", "getServiceEntityMethod", "()Ljava/lang/String;");
            mv.visitVarInsn(ASTORE, 5);
            ...
            mv.visitInsn(AASTORE);
            mv.visitLabel(l0);
            mv.visitLdcInsn(Type.getType("Lorg/sonatype/restsimple/api/PostServiceHandler;"));
            mv.visitVarInsn(ALOAD, 4);
            mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;");
            mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "isAssignableFrom", "(Ljava/lang/Class;)Z");
            Label l5 = new Label();
            ...
            mv.visitVarInsn(ALOAD, 4);
            mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;");
            mv.visitTypeInsn(CHECKCAST, "org/sonatype/restsimple/api/PostServiceHandler");
            mv.visitMethodInsn(INVOKEVIRTUAL, "org/sonatype/restsimple/api/PostServiceHandler", "formParams", "()Ljava/util/List;");
            ...
            Label l6 = new Label();
            mv.visitLabel(l6);
            mv.visitFrame(Opcodes.F_FULL, 12, new Object[]{className, "java/lang/String", "java/lang/String", "java/lang/String", "org/sonatype/restsimple/api/ServiceHandler", "java/lang/String", "[Ljava/lang/Class;", "[Ljava/lang/Object;", Opcodes.TOP, "java/util/List", Opcodes.INTEGER, "java/util/Iterator"}, 0, new Object[]{});
            ...
            mv.visitLabel(l5);
            mv.visitFrame(Opcodes.F_FULL, 8, new Object[]{className, "java/lang/String", "java/lang/String", "java/lang/String", "org/sonatype/restsimple/api/ServiceHandler", "java/lang/String", "[Ljava/lang/Class;", "[Ljava/lang/Object;"}, 0, new Object[]{});
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, className, "serviceEntity", "Lorg/sonatype/restsimple/api/ServiceEntity;");
            mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;");
            mv.visitVarInsn(ALOAD, 5);
            mv.visitVarInsn(ALOAD, 6);
...

        {
            ...
            mv.visitInsn(ARETURN);
            mv.visitLabel(l2);
            mv.visitFrame(Opcodes.F_FULL, 9, new Object[]{className, "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "org/sonatype/restsimple/api/ServiceHandler", "java/lang/String", "[Ljava/lang/Class;", "[Ljava/lang/Object;"}, 1, new Object[]{"java/lang/Throwable"});
            mv.visitVarInsn(ASTORE, 9);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, className, "logger", "Lorg/slf4j/Logger;");
