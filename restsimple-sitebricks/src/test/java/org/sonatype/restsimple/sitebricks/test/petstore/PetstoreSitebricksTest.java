...
public class PetstoreSitebricksTest {

    private static final Logger logger = LoggerFactory.getLogger(PetstoreSitebricksTest.class);
    ...
    public void setUpGlobal() throws Exception {
        ...
        context.addEventListener(new PetstoreSitebricksConfig());
