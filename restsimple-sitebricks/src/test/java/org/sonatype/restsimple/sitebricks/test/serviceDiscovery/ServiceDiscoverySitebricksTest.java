...
public class ServiceDiscoverySitebricksTest {

    private static final Logger logger = LoggerFactory.getLogger(ServiceDiscoverySitebricksTest.class);
    ...
    public void setUpGlobal() throws Exception {
        ...
        context.addEventListener(new ServiceDiscoverySitebricksConfig());
